...
This document outlines the organizational structure of the CASM project 
and some guidelines how you can contribute to it. 
...
the [[https://github.com/casm-lang/casm/blob/master/.github/CODE_OF_CONDUCT.org][Contributor Covenant Code of Conduct]], 
...
open a [[https://github.com/casm-lang/casm/issues/new][new issue]] there and assign the =question= label.
...
If you want to start your contribution, look out for =good first issue= and =help wanted= labeled issues
